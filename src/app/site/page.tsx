  ...
  return (
    <>
      <section className="h-full w-full pt-36 relative flex items-center justify-center flex-col">
        ...
        <div className="bg-gradient-to-r from-primary to-white text-transparent bg-clip-text relative">
      ...
      <section className="flex justify-center flex-col gap-4 md:!mt-20 mt-[40px]">
        ...
        <p className="text-muted-foreground text-center">
          Our straightforward pricing plans are tailored to meed your needs. If{" "}
